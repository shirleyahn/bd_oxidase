...
n, bins, patches = plt.hist(dist, numBins, label='Mtb (with disulfide bond) oxygen channel', color='dodgerblue', alpha=0.8, rwidth=0.9, density=False, range=(0.0, 2500.0))
